                ...
                <div class="row as_verticle_center">
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12">
                        <div class="as_banner_img text-center">
                            <img src="{{asset('frontend/assets/images/hand_bg.png')}}" alt="" class="img-responsive as_hand_bg">
                            <img src="{{asset('frontend/assets/images/hand.png')}}" alt="" class="img-responsive as_hand">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-12 text-center">
                        <h1 class="as_heading">About Astropedia</h1>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="as_aboutimg text-right">
                            <img src="{{asset('frontend/assets/images/about.jpg')}}" alt="" class="img-responsive">
                            <span class="as_play"><img src="{{asset('frontend/assets/images/play.png')}}" alt=""></span>
                        </div> 
                    </div>
                    <div class="col-lg-6 col-md-6">
                        <div class="as_about_detail">
                            ...
                            <div class="as_contact_expert">
                                <span class="as_icon">
                                   <img src="{{asset('frontend/assets/images/svg/about.svg')}}" alt="">
                                </span>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 col-sm-4 col-xs-6">
                        <div class="as_sign_box text-center">
                            <a href="{{route('horoscope.yearly')}}">
                                <span class="as_sign"> 
                                <img src="{{asset('images/horoscope/'.$zodiac_sign->image)}}" alt="">
                                </span>
                                <div>
                                    <h5>{{$zodiac_sign->name}}</h5>
                                    <p>{{\Carbon\Carbon::createFromFormat('Y-m-d', $zodiac_sign->date_from)->format('M d')}} - {{\Carbon\Carbon::createFromFormat('Y-m-d', $zodiac_sign->date_to)->format('M d')}}</p>
                                </div>
                            </a>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 text-center">
                        ...
                        <div class="text-center as_padderTop60">
                            <a href="{{route('shop')}}" class="as_btn">view more</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-12 col-md-12 text-center">
                        ...
                        <div class="v3_blog_wrapper">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                                <div class="as_blog_box">
                                    <div class="as_blog_img">
                                        <a href="blog_detail.html"><img src="{{asset('frontend/assets/images/blog1.jpg')}}" alt="" class="img-responsive"></a>
                                    ...
                                    <div class="as_blog_detail">
                                        ...
                                        <h4 class="as_subheading"><a href="blog.html"> Consectetur adipiscing elit sedeius mod tempor incididunt ut labore.</a></h4>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                                <div class="as_blog_box">
                                    <div class="as_blog_img">
                                        <a href="blog_detail.html"><img src="{{asset('frontend/assets/images/blog2.jpg')}}" alt="" class="img-responsive"></a>
                                        <span class="as_btn">July 29, 2020</span>
                                    </div>
                                    <div class="as_blog_detail">
                                        <ul>
                                            <li><a href="blog.html"><img src="{{asset('frontend/assets/images/svg/user2.svg')}}" alt="">By - Admin</a></li>
                                            <li><a href="blog.html"><img src="{{asset('frontend/assets/images/svg/comment1.svg')}}" alt="">0 comments</a></li>
                                        </ul>blog.html
                                        <h4 class="as_subheading"><a href="blog.html"> Consectetur adipiscing elit sedeius mod tempor incididunt ut labore.</a></h4>
                                        <p class="as_font14 as_margin0">Consectetur adipiscing elit, sed desdo eiusmod tempor incididuesdeentiut labore etesde doloesire esdesdeges magna aliquapspendisse and the gravida.</p>
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                                <div class="as_blog_box">
                                    <div class="as_blog_img">
                                        <a href="blog_detail.html"><img src="{{asset('frontend/assets/images/blog3.jpg')}}" alt="" class="img-responsive"></a>
                                        <span class="as_btn">July 29, 2020</span>
                                    </div>
                                    <div class="as_blog_detail">
                                        <ul>
