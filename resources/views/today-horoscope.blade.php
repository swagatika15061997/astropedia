                        ...
                        <div class="card zodiac-card">
                          <div class="inline-content">
                              ...
                              <div class="zodiac-content">
                                  <h5>{{$zodiacSign->name}} Today's Horoscope</h5>
                                  @if ($zodiacSign->dailyHoroscope)
                                  <div class="zodiac-content" style="display: flex;">
                                     <p>{{ $zodiacSign->dailyHoroscope->category }}:</p>
                                     <p>{!! substr($zodiacSign->dailyHoroscope->description, 0, 210) !!}... <span><a href="{{route('horoscope.details',['zodiac_sign_id' => $zodiacSign->id,'horoscopeDate' => $dt])}}"><b>read more</b></a></span></p>
                                  </div>                                  
                                  @else
