                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                                <h4 class="mb-sm-0">Astrologer Details</h4>
                    ...
                    <div class="row">
                        <div class="col-xxl-3">
                            <div class="card">
                                    ...
                                    <div>
                                        <div class="flex-shrink-0 avatar-md mx-auto">
                                            <div class="avatar-title bg-light rounded">
                                                <img src="{{asset('images/profile/'.$astrologer->image)}}" onerror="this.src='{{asset('backend/assets/images/demo/def.jpg')}}'" alt="" height="50" />
                                            </div>
                                        </div>
                                        <div class="mt-4 text-center">
                                            <h5 class="mb-1">{{$astrologer->name}}</h5>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                         @if ($astrologer->status=="pending")
                                                           <span>
                                                           <a class="text-danger d-inline-block remove-item-btn" data-bs-toggle="modal" href="#approve">
                                                               <button type="button" class="btn btn-primary waves-effect waves-light">Approve</button>
                                                           </a>
                                                           <a class="text-danger d-inline-block remove-item-btn" data-bs-toggle="modal" href="#reject">
                                ...
                                <!--end card-body-->
                                <!-- modal -->
                                <div class="modal fade zoomIn" id="approve" tabindex="-1" aria-hidden="true">
                               <div class="modal-dialog modal-dialog-centered">
                                   <div class="modal-content">
                                       ...
                                       <div class="modal-body">
                                           ...
                                           <i class="ri-checkbox-circle-line" style="color: #202844;font-size: 74px;"></i>

                                               <div class="mt-4 pt-2 fs-15 mx-4 mx-sm-5">
                                                   <h4>Are you sure ?</h4>
                                                   <p class="text-muted mx-4 mb-0">Are you sure you want to approve status ?</p>
                                               </div>
                                           </div>
                                           <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                                               <button type="button" class="btn w-sm btn-light" data-bs-dismiss="modal">Close</button>
                                               <form action="{{ route('astrologer.status-update', $astrologer->id) }}" method="POST">
                                                   @csrf
                                                   <input type="text" name="status" id="" value="approved" style="display:none">
                                ...
                                <!-- end modal -->
                                <!-- modal -->
                                <div class="modal fade zoomIn" id="reject" tabindex="-1" aria-hidden="true">
                               <div class="modal-dialog modal-dialog-centered">
                                   <div class="modal-content">
                                       <div class="modal-header">
                                           <button type="button" class="btn-close" id="deleteRecord-close" data-bs-dismiss="modal" aria-label="Close" id="btn-close"></button>
                                       ...
                                       <div class="modal-body">
                                           <div class="mt-2 text-center">
                                               <i class="ri-close-circle-line" style="font-size: 74px;color:#f7b84b"></i>
                                               <div class="mt-4 pt-2 fs-15 mx-4 mx-sm-5">
                                                   <h4>Are you sure ?</h4>
                                                   <p class="text-muted mx-4 mb-0">Are you sure you want to reject status ?</p>
                                               </div>
                                           ...
                                           <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                                               ...
                                               <form action="{{ route('astrologer.status-update', $astrologer->id) }}" method="POST">
                                                   @csrf
                                                    <input type="text" name="status" id="" value="rejected" style="display:none">
                                                   <button type="submit" class="btn w-sm btn-danger" id="delete-record">Yes, change It!</button>
                                                </form>
                                           </div>
                                       </div>
