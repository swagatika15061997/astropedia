           ...
           <div class="row">
               <div class="col-12">
                   <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                       <h4 class="mb-sm-0">Astrologers</h4>

                       <div class="page-title-right">
                           <ol class="breadcrumb m-0">
                               <li class="breadcrumb-item"><a href="javascript: void(0);">Dashboard</a></li>
                               <li class="breadcrumb-item active">Astrologers</li>
                           </ol>
                       </div>
                   ...
                   <div class="card" id="customerList">
                       <div class="card-header border-bottom-dashed">
                           ...
                           <div class="row g-4 align-items-center">
                               <div class="col-sm">
                                   <div>
                                       <h5 class="card-title mb-0">Astrologer List</h5>
                                   </div>
                               </div>
                               ...
                               <div class="row g-3">
                                   <div class="col-xl-6">
                                       <div class="search-box">
                                           <input type="text" class="form-control search" placeholder="Search for astrologer...">
                       ...
                       <div class="card-body">
                                   ...
                                   <table class="table align-middle" id="customerTable">
                                       ...
                                       <tbody class="list form-check-all">
                                         @foreach($astrologers as $key=>$astrologer)
                                           <tr>
                                               <td>{{++$key}}</td>
                                               <td class="customer_name">{{$astrologer->name}}</td>
                                               <td class="email">{{$astrologer->email}}</td>
                                               <td class="phone">{{$astrologer->phone}}</td>
                                               <td class="date">
                                                 <img src="{{asset('images/profile/'.$astrologer->image)}}" onerror="this.src='{{asset('backend/assets/images/demo/def.jpg')}}'" class="rounded-circle img-thumbnail user-profile-image material-shadow" alt="image" style="width: 5rem;">
                                               </td>
                                               <td class="status">
                                               ...
                                               <td>
                                                   <ul class="list-inline hstack gap-2 mb-0">
                                                       <li class="list-inline-item edit" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Edit">
                                                           <a href="{{ route('astrologer.view', $astrologer->id) }}" class="text-primary d-inline-block edit-item-btn">
                                                               <i class="ri-eye-fill fs-16"></i>
                                                           </a>
                                                       </li>
                                                       <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Remove">
                                                           <a class="text-danger d-inline-block remove-item-btn" data-bs-toggle="modal" href="#deleteRecordModal_{{$astrologer->id}}">
                           ...
                           <div class="modal fade zoomIn" id="deleteRecordModal_{{$astrologer->id}}" tabindex="-1" aria-hidden="true">
                               <div class="modal-dialog modal-dialog-centered">
                                   <div class="modal-content">
                                       ...
                                       <div class="modal-body">
                                           ...
                                           <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                                               ...
                                               <form action="{{ route('astrologer.destroy', $astrologer->id) }}" method="POST">
                                                   @csrf
                                                   @method('DELETE')
