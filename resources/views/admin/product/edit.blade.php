                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control"  name="unit_price" value="{{$product->unit_price}}">
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <div class="text-center">
                                               <div class="profile-user position-relative d-inline-block mx-auto  mb-4">
                                                   <img  onerror="this.src='{{asset('backend/assets/images/demo/def.jpg')}}'" src="{{asset('images/products/thumbnail/'.$product->thumbnail)}}" class="rounded-circle avatar-xl img-thumbnail user-profile-image material-shadow" alt="user-profile-image">
                                                 ...
                                                 <div class="upload__img-wrap">
                                                    ...
                                                    @foreach ($images as $image)
                                                        <div class="upload__img-box">
                                                            <div class="img-bg" style="background-image: url('{{ asset('images/products/' . $image) }}')">
                                                                <div class="upload__img-close" data-image="{{ $image }}"></div>
                                                            </div>
                                                        </div>
                                                    @endforeach
                                                 </div>
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane active" id="addproduct-metadata" role="tabpanel">
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" name="meta_title" placeholder="Enter meta title" value="{{$product->meta_title}}">
                                                        </div>
                                                    </div>
                                                    <!-- end col -->
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" name="meta_keyword" placeholder="Enter meta keywords" value="{{$product->meta_keyword}}">
                                                        </div>
                                                    </div>
                                                    <!-- end col -->
                                                </div>
                                                ...
                                                <div>
                                                    ...
                                                    <textarea class="form-control"  name="meta_description" placeholder="Enter meta description" rows="3">{{$product->meta_description}}</textarea>
                                                </div>
                                            </div>
                                            <!-- end tab pane -->
                                        </div>
