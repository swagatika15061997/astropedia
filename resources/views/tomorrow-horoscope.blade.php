                        ...
                        <div class="card zodiac-card">
                          <div class="inline-content">
                              ...
                              <div class="zodiac-content">
                                  <h5>{{$zodiacSign->name}} Tomorrow's Horoscope</h5>
                                  @if ($zodiacSign->dailyHoroscope)
                                  <div class="zodiac-content" style="display: flex;">
                                     <p>{{ $zodiacSign->dailyHoroscope->category }}:</p>
                                     <p>{!! substr($zodiacSign->dailyHoroscope->description, 0, 210) !!}{{ strlen($zodiacSign->dailyHoroscope->description) > 200 ? '...' : '' }} <span><a href=""><b>read more</b></a></span></p>
                                  </div>                                  
                                  @else
