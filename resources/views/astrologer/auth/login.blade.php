            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card mt-4 card-bg-fill">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    ...
                                    <p class="text-muted">Sign in to continue to astropedia.</p>
                                </div>
                                <div class="p-2 mt-4">
                                    <!-- @if($errors->any())
                                    ...
                                    @endif -->
                                    <form action="{{route('astrologer.login_submit')}}" method="post">
                                        @csrf
                                        <div class="mb-3">
                        ...
                        <div class="mt-4 text-center">
                            <p class="mb-0">Don't have an account ? <a href="{{route('astrologer.register')}}" class="fw-semibold text-primary text-decoration-underline"> Signup </a> </p>
                        </div>
